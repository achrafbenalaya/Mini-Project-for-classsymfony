...
use region\regionBundle\Entity\Region;
...
class RegionController extends Controller
{
    ...
    {
        $region = new Region();
        $form = $this->createForm('region\regionBundle\Form\RegionType', $region);
    ...
    {
        $deleteForm = $this->createDeleteForm($region);
        $editForm = $this->createForm('region\regionBundle\Form\RegionType', $region);
